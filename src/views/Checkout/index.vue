...
const getActiveAddr = (activeItem) => {
  activeAddress.value = activeItem
}
// 切换地址
const comfirmChange = () => {
  ...
  } else return showDialog.value = false
}
...
<template>
  ...
  <el-dialog v-model="showDialog" title="切换收货地址" width="30%" center>
    <div class="addressWrapper">
      <div class="text item" v-for="item in checkInfo.userAddresses" :key="item.id" @click="getActiveAddr(item)"
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="comfirmChange">确定</el-button>
      </span>
    </template>
  </el-dialog>
  <!-- 添加地址 -->
